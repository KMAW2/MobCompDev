...
import ru.mirea.ivanovea.firebaseauth.databinding.FragmentGetWeatherBinding;

public class GetWeatherFragment extends Fragment {

    private FragmentGetWeatherBinding binding;
     ...
     * @return A new instance of fragment GetWeatherFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static GetWeatherFragment newInstance(String param1, String param2) {
        GetWeatherFragment fragment = new GetWeatherFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        super.onCreate(savedInstanceState);
        binding = FragmentGetWeatherBinding.inflate(getLayoutInflater());
